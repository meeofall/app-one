      ...
      <div class="col-md-5 col-lg-3">
        <div class="card-p mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <h6 class="card-price text-center"><span class="double-strike"><div class="the-lines"></div>N</span>0.00<span class="period">/month</span></h6>
            <hr />
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>1-25 Students</li>
              ...
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Website Sync</li>
      ...
      <div class="col-md-5 col-lg-3">
        <div class="card-p mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <hr />
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span><strong>25-60 Students</strong></li>
        ...
        <div class="card-p mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check"></i></span>24/7 Support</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Dedicated Phone Support</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span><strong>Unlimited</strong> Free Website Sync</li>
