...
function Pricing() {
    return (
        <div>
             <div class="container container-fluid pricing justify-content-center mt-5 mb-5">
          <h2 class="pricing-h2 text-center mb-2 mt-5">Pricing</h2>
          <p class="text-center mb-4">At iNovate OS, we believe in clear and simple pricing. <br />That’s why we operate iSM on a month-to-month subscription based pricing model.<br /><br /><i><span class="highlighted">...and at the most competitive rate you can get.</span></i></p>
  <div class="container">
    <div class="row">
        ...
        <div class="card-p mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check"></i></span>250GB Storage</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Complete Access</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Email Support</li>
