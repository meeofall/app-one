    ...
    return (
      <div class="contact-head">
        ...
        <div class="container container-fluid bg-white contact1 pt-5 mt-5">
          ...
          <p class="pb-2 mb-2">We are available Monday - Friday, 9:00AM - 5:00PM WAT</p>
          <div class="p-2 pb-5 contact-link"><a class="pr-4" href="https://tawk.to/chat/603aa30e385de407571ac663/1evigpt5m" target="_blank"><i class="fas fa-comments contact-icons"></i></a>
            <a class="pr-4 contact-icons" href="https://api.whatsapp.com/send?phone=+2349015114004" target="_blank"><i class="fab fa-whatsapp contact-icons"></i></a>
            <a class="pr-4 contact-icons" href="tel:+2349015114004"><i class="fas fa-phone contact-icons"></i></a> </div>
          ...
          <div class="row">
            <div class="col-lg-8" xs="auto">
              <div class="contact-box p-4">
                        <h4 class="title text-primary">Contact our sales team</h4>
                        <p class="title text-secondary">Fill out the form and we will get back to you</p>
                <form>
                  <div class="row">
              ...
              <div class="detail-box p-4">
                ...
                <div class="round-social">
                  ...
                  <a href="twitter.com/inovate_os" class="link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="blue" class="bi bi-twitter" viewBox="0 0 16 16">
                                    ...
                                    3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323
                                    3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23
                                    3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32
                ...
                <a href="#!" class="link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="tomato" class="bi bi-youtube" viewBox="0 0 16 16">
                                    ...
                                    1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.075c-.001.194-.01 1.108-.082
                                    2.06l-.008.105-.009.104c-.05.572-.124 1.14-.235 1.558a2.007 2.007 0 0 1-1.415
                                    1.42c-1.16.312-5.569.334-6.18.335h-.142c-.309 0-1.587-.006-2.927-.052l-.17-.006-.087-.004-.171-.007-.171-.007c-1.11-.049-2.167-.128-2.654-.26a2.007
                                    2.007 0 0 1-1.415-1.419c-.111-.417-.185-.986-.235-1.558L.09 9.82l-.008-.104A31.4 31.4 0 0 1 0
                                    7.68v-.122C.002 7.343.01 6.6.064 5.78l.007-.103.003-.052.008-.104.022-.26.01-.104c.048-.519.119-1.023.22-1.402a2.007
                                    2.007 0 0 1 1.415-1.42c.487-.13 1.544-.21 2.654-.26l.17-.007.172-.006.086-.003.171-.007A99.788 99.788
                                    0 0 1 7.858 2h.193zM6.4 5.209v4.818l4.157-2.408L6.4 5.209z"/>
                    </svg>
                </a>
